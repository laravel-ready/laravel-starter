        ...
        <div class="relative flex justify-center py-4 bg-gray-100 items-top dark:bg-gray-900 sm:items-center sm:pt-0">
            @if (Route::has('login'))
                <div class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/home') }}" class="text-sm text-gray-700 underline dark:text-gray-300 dark:hover:text-gray-100">Home</a>
                    @else
                        <a href="{{ route('login') }}" class="text-sm text-gray-700 underline dark:text-gray-300 dark:hover:text-gray-100">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline dark:text-gray-300 dark:hover:text-gray-100">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
        ...
        <div class="mx-auto max-w-[43rem]">
            <div class="text-center">
                ...
                <p class="mt-3 text-lg leading-relaxed text-slate-400">
                    ...
                    <a href="https://github.com/laravel-ready/laravel-starter/blob/main/DOCS.md" class="text-indigo-600 hover:underline dark:text-indigo-400/95 dark:hover:text-indigo-300/95">
                        Laravel Ready Docs
                    </a>
                </p>
            </div>
            ...
            <div class="flex items-center justify-center gap-4 mt-6">
                <a href="https://github.com/laravel-ready/laravel-starter"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24" class="mr-3 fill-white">
                        <path
                ...
                @if (config('app.env') !== 'production' && str()->contains(url()->current(), 'localhost'))
                    <a href="{{ 'http://localhost:3000' }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"
                            class="mr-2 group-hover:fill-indigo-600">
                            <path
